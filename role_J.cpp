...
Role_J::Role_J(int j, int i, bool enemy, int health, int attack_power, int attack_interval, int cost, QString name)
...
void Role_J::SkillBegin(Game&game) {}

void Role_J::SkillEnd() {}
void Role_J::Attack(Game *game)
{
